...
public partial class MyGuitarShopContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Addresse__091C2A1B05325D84");
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Administ__719FE4E87DD99F9B");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2B8DCCAABD");

            entity.HasIndex(e => e.CategoryName, "UQ__Categori__8517B2E0B4F92695").IsUnique();
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B876092E07");

            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A147407F92EBC3").IsUnique();
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF906BC2A8");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__OrderIte__727E83EB552CE270");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6EDE601BD75");

            entity.HasIndex(e => e.ProductCode, "UQ__Products__2F4E024FB2783D53").IsUnique();
